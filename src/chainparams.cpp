...
public:
	...
	nMinerThreads = 0;
	nTargetTimespan = 1 * 60; // EMIT: 60s
	nTargetSpacing = 1 * 60; // EMIT: 60s
	nLastPOWBlock = 518400; // EMIT: 360 Days.
...
public:
	...
	// Using Bitcoin defaults for Testnet
        ...
        // Testnet emit BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EMIT: 1 day
        nTargetSpacing = 1 * 60;        // EMIT: 1 minutes
