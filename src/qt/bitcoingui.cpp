                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EMIT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EMIT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and emit: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EMIT Core"), this);
    aboutAction->setStatusTip(tr("Show information about EMIT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EMIT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EMIT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EMIT addresses"));
    ...
    openAction->setStatusTip(tr("Open a EMIT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EMIT Core help message to get a list with possible EMIT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EMIT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EMIT network", "", count));
}
...
{
    QString strTitle = tr("EMIT Core"); // default title
