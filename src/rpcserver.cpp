...
static const CRPCCommand vRPCCommands[] =
	...
	{"util", "makekeypair", &makekeypair, true, false, false},
        ...
        /* EMIT features */
        {"emit", "masternode", &masternode, true, true, false},
        {"emit", "listmasternodes", &listmasternodes, true, true, false},
        {"emit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"emit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"emit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"emit", "masternodedebug", &masternodedebug, true, true, false},
        {"emit", "startmasternode", &startmasternode, true, true, false},
        {"emit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"emit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"emit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"emit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"emit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"emit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"emit", "mnbudget", &mnbudget, true, true, false},
        {"emit", "preparebudget", &preparebudget, true, true, false},
        {"emit", "submitbudget", &submitbudget, true, true, false},
        {"emit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"emit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"emit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"emit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"emit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"emit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"emit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"emit", "checkbudgets", &checkbudgets, true, true, false},
        {"emit", "mnsync", &mnsync, true, true, false},
        {"emit", "spork", &spork, true, true, false},
        {"emit", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"emit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use emitd, or the -server option to emit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"EMIT Alert\" admin@foo.com\n"),
...
{
    return "> emit-cli " + methodname + " " + args + "\n";
}
