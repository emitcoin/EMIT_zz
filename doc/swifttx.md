...
This mechanism has been integrated into Bitcore-Node-EMIT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EMIT-Project/insight-api-emit#web-socket-api](https://github.com/EMIT-Project/insight-api-emit#web-socket-api) 
* API: [https://github.com/EMIT-Project/insight-api-emit#swifttx-transactions](https://github.com/EMIT-Project/insight-api-emit#swifttx-transactions) 
...
By default, the EMIT Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EMIT Core daemon:
