...
RESOURCES += src/qt/emit.qrc src/qt/emit_locale.qrc

TRANSLATIONS += src/qt/locale/emit_bg.ts \
                src/qt/locale/emit_de.ts \
                src/qt/locale/emit_en.ts \
                src/qt/locale/emit_es.ts \
                src/qt/locale/emit_fi.ts \
                src/qt/locale/emit_fr.ts \
                src/qt/locale/emit_it.ts \
                src/qt/locale/emit_ja.ts \
                src/qt/locale/emit_pl.ts \
                src/qt/locale/emit_pt.ts \
                src/qt/locale/emit_ru.ts \
                src/qt/locale/emit_sk.ts \
                src/qt/locale/emit_sv.ts \
                src/qt/locale/emit_vi.ts \
                src/qt/locale/emit_zh_CN.ts \
                src/qt/locale/emit_zh_TW.ts
